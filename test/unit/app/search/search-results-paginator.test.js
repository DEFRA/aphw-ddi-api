...
describe('Search results paginator', () => {
  ...
  describe('buildSearchCacheKey', () => {
    test('should return compound string with default values', () => {
      ...
      expect(res).toEqual('testuser@here.com|term1,term2|false|false')
    })
    ...
    test('should return compound string with extra param values', () => {
      ...
      const res = buildSearchCacheKey(user, request)
      expect(res).toEqual('testuser@here.com|term1,term2|true|true')
    })
  })
  ...
  describe('saveResultsToCacheAndGetPageOne', () => {
    test('should save', async () => {
      ...
      expect(set).toHaveBeenCalledWith(request, 'testuser@here.com|term1,term2|false|false', { results: { results: splicedRemainder1to30, totalFound: 30 }, expiry: expect.anything() }, expiryInMins)
      expect(res).toEqual({
        success: true,
