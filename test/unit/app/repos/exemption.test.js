...
describe('Exemption repo', () => {
  ...
  describe('updateExemption', () => {
    ...
    test('updateExemption should start a transaction if one is not provided and status is Insurance Spot check date', async () => {
      const data = {
        exemptionOrder: '2015',
        indexNumber: 'ED123',
        cdoIssued: '2020-01-01',
      ...
      getCdo.mockResolvedValue({ ...cdo, insurance: [] })
      getCourt.mockResolvedValue({ id: 1, name: 'Test Court' })
      getPoliceForce.mockResolvedValue({ id: 1, name: 'Test Police Force' })
