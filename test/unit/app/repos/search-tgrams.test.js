...
describe('Search tgrams repo', () => {
  ...
  describe('populateTrigrams', () => {
    test('should fill table with trigrams', async () => {
      ...
      expect(sequelize.models.search_tgram.create.mock.calls[0]).toEqual([{ dog_id: 1, person_id: null, match_text: '123456789011111' }, { transaction: undefined }])
      expect(sequelize.models.search_tgram.create.mock.calls[1]).toEqual([{ dog_id: 1, person_id: null, match_text: '345345345345345' }, { transaction: undefined }])
      expect(sequelize.models.search_tgram.create.mock.calls[2]).toEqual([{ dog_id: null, person_id: 11, match_text: 'ts11ts' }, { transaction: undefined }])
      expect(sequelize.models.search_tgram.create.mock.calls[3]).toEqual([{ dog_id: 2, person_id: null, match_text: '123456789022222' }, { transaction: undefined }])
      expect(sequelize.models.search_tgram.create.mock.calls[4]).toEqual([{ dog_id: null, person_id: 22, match_text: 'ts22ts' }, { transaction: undefined }])
      expect(sequelize.models.search_tgram.create.mock.calls[5]).toEqual([{ dog_id: 3, person_id: null, match_text: '123456789033333' }, { transaction: undefined }])
      expect(sequelize.models.search_tgram.create.mock.calls[6]).toEqual([{ dog_id: null, person_id: 11, match_text: 'ts11ts' }, { transaction: undefined }])
    })
  })
